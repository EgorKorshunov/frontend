...
function loadAssets(loader) {
  ...
  loader
    ...
    .add('reaction_up1', constructPath('reaction_up1.png'))
    .add('reaction_up2', constructPath('reaction_up2.png'))
    .add('reaction_up3', constructPath('reaction_up3.png'))
    .add('reaction_up4', constructPath('reaction_up4.png'))
    .add('reaction_up5', constructPath('reaction_up5.png'))
    .add('reaction_up6', constructPath('reaction_up6.png'))
    .add('reaction_up7', constructPath('reaction_up7.png'))
    .add('reaction_up8', constructPath('reaction_up8.png'))
    .add('reaction_up9', constructPath('reaction_up9.png'))
    .add('reaction_up10', constructPath('reaction_up10.png'))
    .add('reaction_up11', constructPath('reaction_up11.png'))
    .add('reaction_up12', constructPath('reaction_up12.png'))
    .add('reaction_up13', constructPath('reaction_up13.png'))
    .add('reaction_up14', constructPath('reaction_up14.png'))
    .add('reaction_down1', constructPath('reaction_down1.png'))
    .add('reaction_down2', constructPath('reaction_down2.png'))
    .add('reaction_down3', constructPath('reaction_down3.png'))
    .add('reaction_down4', constructPath('reaction_down4.png'))
    .add('end_bad1', constructPath('end_bad1.png'))
    .add('end_bad2', constructPath('end_bad2.png'))
    .add('end_good1', constructPath('end_good1.png'))
...
class RosiAnimationController {
  ...
  update(dt) {
    ...
    // console.log(currentIntervalIndex);
